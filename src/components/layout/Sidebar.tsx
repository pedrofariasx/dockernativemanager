...
const Sidebar = () => {
  ...
  const { isConnected, manageService } = useDocker();
      ...
      <div className="w-64 border-r bg-sidebar text-sidebar-foreground flex flex-col h-full shrink-0">
        <div className="p-6 border-b border-sidebar-border flex items-center gap-3">
          ...
          <div className="flex-1 cursor-pointer" onClick={() => setShowAboutDialog(true)}>
            ...
            <p className="text-[10px] text-muted-foreground uppercase tracking-widest mt-1 hover:text-primary transition-colors">
        ...
        <DialogContent className="bg-background border-border">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground pt-2">
              This will remove all stopped containers, unused networks, and dangling images. This action cannot be
              undone. Are you sure?
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="mt-6">
            ...
            <Button onClick={handlePrune} className="bg-rose-600 hover:bg-rose-700 text-white" disabled={isPruning}>
                  ...
                  <div key={ctx.name} className="relative group">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start overflow-hidden">
                        ...
                        <span className="text-[10px] text-muted-foreground truncate w-full">{ctx.docker_endpoint}</span>
                      </div>
                    </Button>
                            ...
                            {sshKeys.map((key) => (
                              ...
                              >
                                <KeyRound
                                  className={cn(
                                    "w-3 h-3",
                                    selectedSshKey === key.path ? "text-primary" : "text-muted-foreground",
                                  )}
                                />
          ...
          <div className="py-4 space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  {latestVersion && appVersion && compareVersions(latestVersion, appVersion) > 0 && (
                    <span className="text-[10px] font-bold text-blue-500 animate-pulse bg-blue-500/10 px-2 py-0.5 rounded">
                      Update Available
                    </span>
                  )}
            ...
            <Collapsible className="space-y-2">
              <CollapsibleTrigger asChild>
                ...
                >
                  <h4 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground group-hover:text-foreground transition-colors">
                    Contributors
                  </h4>
                  <div className="flex items-center gap-2">
                ...
                <ScrollArea className="h-[180px] w-full rounded-md border border-sidebar-border p-2 bg-muted/10">
                  <div className="grid gap-2">
                    ...
                    {contributors.length === 0 && !isLoadingContributors && (
                      <p className="text-xs text-center text-muted-foreground py-4 italic">No contributors found.</p>
                    )}
                  </div>
                </ScrollArea>
              </CollapsibleContent>
      ...
      <Dialog open={showUpdateDialog} onOpenChange={setShowUpdateDialog}>
        <DialogContent className="bg-background border-border max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground pt-2">
              A new version of Docker Native Manager is ready. Download the latest release to get the latest features
              and fixes.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4 space-y-5">
            <div className="flex items-center justify-between p-3 bg-blue-500/5 rounded-lg border border-blue-500/10">
              ...
              <div className="flex flex-col items-end">
                <span className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold text-right">
                  Current
                </span>
